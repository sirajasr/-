...
Asena.addCommand({on: 'text', fromMe: false }, (async (message, match) => {
    if(Config.BGMFILTER){
        ...
        if (!!message.mention && message.mention[0] == '34613110267@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Rajavu.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
